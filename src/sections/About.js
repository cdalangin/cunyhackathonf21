    ...
    return (
        <div className="about-bg">
            ...
            <Col xs={12} md={6} className="text-col">  
                <p className="about-text"><b>CUNY Hackathon</b> is in its 6th iteration this fall, with this being the 2nd time it's virtual and the 3rd time it's student-run. We welcome all CUNY students and recent grads (within a year of graduating) regardless of major, skill level, and background. 
                <br/><br/>
